...
(requires `@gsxhq/vite-plugin-gsx` ≥ 0.5.0; auto-show and the log box need ≥ 0.10.0; surviving body-swapping navigations such as htmx `hx-boost` needs ≥ 0.11.2). Disable it or rebind the key in
