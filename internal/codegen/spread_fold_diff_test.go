...
func main() {
	...
	render(ctx, "E1", p.E1())
	render(ctx, "E2", p.E2())
	render(ctx, "E3true", p.E3(true))
	render(ctx, "E3false", p.E3(false))
	render(ctx, "E4", p.E4())
	render(ctx, "E5", p.E5())
	render(ctx, "E6true", p.E6(true))
	render(ctx, "E6false", p.E6(false))
	render(ctx, "E7true", p.E7(true))
	render(ctx, "E7false", p.E7(false))
	render(ctx, "E8true", p.E8(true))
	render(ctx, "E8false", p.E8(false))
	render(ctx, "E9true", p.E9(true))
	render(ctx, "E9false", p.E9(false))
	render(ctx, "E10true", p.E10(true))
	render(ctx, "E10false", p.E10(false))
	render(ctx, "E11true", p.E11(true))
	render(ctx, "E11false", p.E11(false))
}
`)
