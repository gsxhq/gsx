...
`)
	...
	res, err := generateCached([]string{pkgDir}, nil, nil, nil, attrclass.Builtin(), customMatcher, false, nil, nil, true, true, nil)
	if err != nil {
...
`)
	...
	res, err := generateCached([]string{pkgDir}, nil, nil, nil, attrclass.Builtin(), badMatcher, false, nil, nil, true, true, nil)
	if err == nil {
