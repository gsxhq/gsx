...
func TestWatchEquiv(t *testing.T) {
	...
	osRes, osErr := generateCached([]string{dir1}, nil, nil, nil, attrclass.Builtin(), false, nil, nil, nil, true, true, false, nil)
	if osErr != nil {
	...
	os3Res, os3Err := generateCached([]string{dir3}, nil, nil, nil, attrclass.Builtin(), false, nil, nil, nil, true, true, false, nil)
	if os3Err != nil {
...
func TestWatchEquiv_MinifyNone(t *testing.T) {
	...
	osRes, osErr := generateCached([]string{dir1}, nil, nil, nil, attrclass.Builtin(), false, nil, nil, nil, false, false, false, nil)
	if osErr != nil {
