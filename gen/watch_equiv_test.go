...
func TestWatchEquiv(t *testing.T) {
	...
	osRes, osErr := generateCached([]string{dir1}, nil, nil, attrclass.Builtin(), nil, false, nil, nil, true, true)
	if osErr != nil {
	...
	os3Res, os3Err := generateCached([]string{dir3}, nil, nil, attrclass.Builtin(), nil, false, nil, nil, true, true)
	if os3Err != nil {
...
func TestWatchEquiv_MinifyNone(t *testing.T) {
	...
	osRes, osErr := generateCached([]string{dir1}, nil, nil, attrclass.Builtin(), nil, false, nil, nil, false, false)
	if osErr != nil {
