...
`
	...
	requests := []request{
		...
		{id: 6, name: "component declaration", cursor: strings.Index(source, "Card"), wantStart: strings.Index(source, "Card"), wantLength: len("Card"), wantFragments: []string{"component Card[T widgets.Labelish](value T)"}},
